...
const fn semantics(format: GpuTextureFormat) -> GpuTextureFormatSemantics {
    match format {
        ...
        GpuTextureFormat::Rgb9e5Ufloat => GpuTextureFormatSemantics {
            aspect_class: GpuTextureAspectClass::Color,
            block_dimensions: (1, 1),
            color_copy_block_size: Some(4),
            depth_copy_block_size: None,
        ...
        GpuTextureFormat::Rgb10a2Uint => GpuTextureFormatSemantics {
            aspect_class: GpuTextureAspectClass::Color,
            block_dimensions: (1, 1),
            color_copy_block_size: Some(4),
            depth_copy_block_size: None,
        ...
        GpuTextureFormat::Rgb10a2Unorm => GpuTextureFormatSemantics {
            aspect_class: GpuTextureAspectClass::Color,
            block_dimensions: (1, 1),
            color_copy_block_size: Some(4),
            depth_copy_block_size: None,
        ...
        GpuTextureFormat::Rg11b10Ufloat => GpuTextureFormatSemantics {
            aspect_class: GpuTextureAspectClass::Color,
            block_dimensions: (1, 1),
            color_copy_block_size: Some(4),
            depth_copy_block_size: None,
    ...
    fn bc_family_has_exact_block_shader_and_view_semantics() {
        let cases = [
            ...
            (
                ...
                8,
                true,
                Some(GpuTextureFormat::Bc1RgbaUnorm),
                4,
                true,
            ),
            (
                ...
                16,
                false,
                Some(GpuTextureFormat::Bc2RgbaUnormSrgb),
                4,
                true,
            ),
            (
                ...
                16,
                true,
                Some(GpuTextureFormat::Bc2RgbaUnorm),
                4,
                true,
            ),
            (
                ...
                16,
                false,
                Some(GpuTextureFormat::Bc3RgbaUnormSrgb),
                4,
                true,
            ),
            (
                ...
                16,
                true,
                Some(GpuTextureFormat::Bc3RgbaUnorm),
                4,
                true,
            ),
