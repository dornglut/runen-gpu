use super::super::texture_format_mapping::texture_format as map_texture_format;
...
mod tests {
    ...
    fn normalized_mappings_cover_every_current_resource_enum() {
        ...
        assert!(texture_format::paired_view_format(GpuTextureFormat::Rgba8Snorm).is_none());
